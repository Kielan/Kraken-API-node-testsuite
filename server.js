...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(285);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config__ = __webpack_require__(286);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__config__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__constants__ = __webpack_require__(289);
function asyncGeneratorStep(gen,resolve,reject,_next,_throw,key,arg){try{var info=gen[key](arg);var value=info.value;}catch(error){reject(error);return;}if(info.done){resolve(value);}else{Promise.resolve(value).then(_next,_throw);}}function _asyncToGenerator(fn){return function(){var self=this,args=arguments;return new Promise(function(resolve,reject){var gen=fn.apply(self,args);function _next(value){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"next",value);}function _throw(err){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"throw",err);}_next(undefined);});};}var path=__webpack_require__(278);var express=__webpack_require__(279);//const compression = require('compression');
var cookieParser=__webpack_require__(280);var fs=__webpack_require__(281);var https=__webpack_require__(282);var bodyParser=__webpack_require__(283);var cors=__webpack_require__(284);var credentials={key:fs.readFileSync('./key.pem','utf8'),cert:fs.readFileSync('./cert.pem','utf8')};// this function is called when you want the server to die gracefully
// i.e. wait for existing connections
var gracefulShutdown=function gracefulShutdown(){console.log("Received kill signal, shutting down gracefully.");secureApp.close(function(){console.log("Closed out remaining connections.");process.exit();});// if after
setTimeout(function(){console.error("Could not close connections in time, forcefully shutting down");process.exit();},10*1000);};var app=express();var jsonParser=bodyParser.json();app.use(bodyParser.urlencoded({extended:true}));app.use(bodyParser.json());//app.use(compression());
app.use(cookieParser());if(process.env.NODE_ENV!='production'){app.use('/',express.static(path.join(process.cwd(),'public')));}app.set('views',path.join(process.cwd(),'views'));app.set('view engine','pug');app.get('*',function(req,res){res.locals.app_stylesheets='<script src="/src/layouts/main.js"></script>';res.locals.app_scripts="\n <script src=\"/js/plugins.js\"></script>\n <script src=\"/js/app.js\"></script> \n <script src=\"https://maps.googleapis.com/maps/api/js?key=".concat(__WEBPACK_IMPORTED_MODULE_1__config__["appConfig"].MAPS_API_KEY,"&libraries=places&callback=initAutocomplete\"\n        async defer></script> \n");console.log('url hit');res.render('index',{title:'Hey',message:'Hello there!'});});//renderHTML);
var secureApp=https.createServer(credentials,app).listen(__WEBPACK_IMPORTED_MODULE_1__config__["appConfig"].httpsPort,/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee(){var krakPromise;return regeneratorRuntime.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:console.log("Node.js app is running at https://localhost:".concat(__WEBPACK_IMPORTED_MODULE_1__config__["appConfig"].httpsPort,"/"));_context.prev=1;krakPromise=new Promise(function(resolve,reject){//      return kraken.api('Assets', { asset: 'BCH,XXBT' })
//  return kraken.api('AssetPairs', {pair: 'ETHEUR'})
return __WEBPACK_IMPORTED_MODULE_2__constants__["a" /* kraken */].api('Ticker',{pair:'XBTEUR'});//  return kraken.api('OHLC', { pair: 'ETHEUR' })
//  return kraken.api('Time')
}).catch(function(e){console.log('caught promise error',e);});_context.t0=console;_context.next=6;return krakPromise;case 6:_context.t1=_context.sent;_context.t0.log.call(_context.t0,'kraken api await on the server in cli',_context.t1);_context.next=13;break;case 10:_context.prev=10;_context.t2=_context["catch"](1);console.log('async await e',_context.t2);case 13:case"end":return _context.stop();}}},_callee,this,[[1,10]]);})));// listen for TERM signal .e.g. kill
process.on('SIGTERM',gracefulShutdown);// listen for INT signal e.g. Ctrl-C
process.on('SIGINT',gracefulShutdown);//exports default secureApp
...
"use strict";
var config=process.env.NODE_ENV=='production'?__webpack_require__(287):__webpack_require__(288);module.exports=config;
...
"use strict";
exports.appConfig={"httpSecure":process.env.HTTP_SECURE||3442,"wdsPort":process.env.WDS_PORT||8079,"httpsPort":process.env.HTTPS_PORT||3443,"MAPS_API_KEY":'AIzaSyCBP2rjBl6gpO1cGVed0wB-_E1JEXSJte0'};
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return kraken; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_lib_kraken__ = __webpack_require__(290);
var kk={public_key:'UK/voBX4cjpA9ZYD03SS2eKSyHU0UMzfemrihFKklpr',private_key:'bSpSsykugf2Gzdye4rJwUiNN5Z0H3OJFCPq8T1m4GOU0Vafv1LzAnMcgIic15se'};var kraken=new __WEBPACK_IMPORTED_MODULE_0__src_lib_kraken__["a" /* KrakenClient */](kk.public_key,kk.private_key);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return KrakenClient; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(291);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_crypto__ = __webpack_require__(293);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_qs__ = __webpack_require__(294);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_qs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_qs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_react_zlib_js_buffer__ = __webpack_require__(295);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_react_zlib_js_buffer___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_react_zlib_js_buffer__);
function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}function _createClass(Constructor,protoProps,staticProps){if(protoProps)_defineProperties(Constructor.prototype,protoProps);if(staticProps)_defineProperties(Constructor,staticProps);return Constructor;}function _typeof(obj){if(typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"){_typeof=function _typeof(obj){return typeof obj;};}else{_typeof=function _typeof(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};}return _typeof(obj);}function asyncGeneratorStep(gen,resolve,reject,_next,_throw,key,arg){try{var info=gen[key](arg);var value=info.value;}catch(error){reject(error);return;}if(info.done){resolve(value);}else{Promise.resolve(value).then(_next,_throw);}}function _asyncToGenerator(fn){return function(){var self=this,args=arguments;return new Promise(function(resolve,reject){var gen=fn.apply(self,args);function _next(value){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"next",value);}function _throw(err){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"throw",err);}_next(undefined);});};}var request=__webpack_require__(292);// Public/Private method names
var methods={public:['Time','Assets','AssetPairs','Ticker','Depth','Trades','Spread','OHLC'],private:['Balance','TradeBalance','OpenOrders','ClosedOrders','QueryOrders','TradesHistory','QueryTrades','OpenPositions','Ledgers','QueryLedgers','TradeVolume','AddOrder','CancelOrder','DepositMethods','DepositAddresses','DepositStatus','WithdrawInfo','Withdraw','WithdrawStatus','WithdrawCancel']// Default options
};var defaults={url:'https://api.kraken.com',version:0,timeout:5000// Create a signature for a request
};var getMessageSignature=function getMessageSignature(path,request,secret,nonce){var message=__WEBPACK_IMPORTED_MODULE_2_qs___default.a.stringify(request);var secret_buffer=new __WEBPACK_IMPORTED_MODULE_3_react_zlib_js_buffer___default.a(secret,'base64');var hash=new __WEBPACK_IMPORTED_MODULE_1_crypto___default.a.createHash('sha256');var hmac=new __WEBPACK_IMPORTED_MODULE_1_crypto___default.a.createHmac('sha512',secret_buffer);var hash_digest=hash.update(nonce+message).digest('binary');var hmac_digest=hmac.update(path+hash_digest,'binary').digest('base64');return hmac_digest;};// Send an API request
var rawRequest=/*#__PURE__*/function(){var _ref=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee(url,headers,data,clientLib){var options,response,parsedResponse,e;return regeneratorRuntime.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.prev=0;console.log('no sense 1',headers,'sensedata',data);// Set custom User-Agent string
headers['User-Agent']='Kraken Javascript API Client';options={headers:headers};console.log('no sense 2',headers);if(!(clientLib==='axios')){_context.next=12;break;}Object.assign(options,{method:'GET',body:data//data//qs.stringify(data),
});_context.next=9;return __WEBPACK_IMPORTED_MODULE_0_axios___default()(url,options);case 9:response=_context.sent;_context.next=17;break;case 12:Object.assign(options,{uri:url,method:'GET',qs:data,//data//qs.stringify(data),
resolveWithFullResponse:true,json:true});console.log('kraken api options',options);_context.next=16;return request(options);case 16:response=_context.sent;case 17:console.log('kraken api awaitresponse',_typeof(response.body),response.body);//		console.log('kraken api response.data.result', response.data.result)
parsedResponse=response.body;//JSON.parse(response.data.result)
return _context.abrupt("return",parsedResponse);case 22:_context.prev=22;_context.t0=_context["catch"](0);console.log('error catch mickey',_context.t0);console.log('error.request',_context.t0.request);console.log('error.response',_context.t0.response);if(!(_context.t0&&_context.t0.length)){_context.next=32;break;}e=_context.t0.filter(function(e){return e.startsWith('E');}).map(function(e){return e.substr(1);});if(_context.t0.length){_context.next=31;break;}throw new Error("Kraken API returned an unknown error");case 31:throw new Error("Kraken API returned a known error:)",_context.t0);case 32:case"end":return _context.stop();}}},_callee,this,[[0,22]]);}));return function rawRequest(_x,_x2,_x3,_x4){return _ref.apply(this,arguments);};}();/**
 ...
 */var KrakenClient=/*#__PURE__*/function(){function KrakenClient(key,secret,options){_classCallCheck(this,KrakenClient);// Allow passing the OTP as the third argument for backwards compatibility
if(typeof options==='string'){options={otp:options};}this.config=Object.assign({key:key,secret:secret},defaults,options);}/**
	 * This method makes a public or private API request.
	 * @param  {String}   method   The API method (public or private)
	 * @param  {Object}   params   Arguments to pass to the api call
	 * @param  {Function} callback A callback function to be executed when the request is complete
	 * @return {Object}            The request object
	 */_createClass(KrakenClient,[{key:"api",value:function api(method,params,clientLib,callback){// Default params to empty object
if(typeof clientLib==='function'){callback=clientLib;params={};}if(methods.public.includes(method)){return this.publicMethod(method,params,clientLib,callback);}else if(methods.private.includes(method)){return this.privateMethod(method,params,callback);}else{throw new Error(method+' is not a valid API method.');}}/**
		* This method makes a public API request.
		* @param  {String}   method   The API method (public or private)
		* @param  {Object}   params   Arguments to pass to the api call
		* @param  {Function} callback A callback function to be executed when the request is complete
		* @return {Object}            The request object
	*/},{key:"publicMethod",value:function publicMethod(method,params,clientLib,callback){params=params||{};// Default params to empty object
if(typeof params==='function'){callback=params;params={};}var path='/'+this.config.version+'/public/'+method;var url=this.config.url+path;var response=rawRequest(url,{},params,clientLib);if(typeof callback==='function'){response.then(function(result){return callback(null,result);}).catch(function(error){return callback(error,null);});}return response;}/**
	 * This method makes a private API request.
	 * @param  {String}   method   The API method (public or private)
	 * @param  {Object}   params   Arguments to pass to the api call
	 * @param  {Function} callback A callback function to be executed when the request is complete
	 * @return {Object}            The request object
	 */},{key:"privateMethod",value:function privateMethod(method,params,callback){params=params||{};// Default params to empty object
if(typeof params==='function'){callback=params;params={};}var path='/'+this.config.version+'/private/'+method;var url=this.config.url+path;if(!params.nonce){params.nonce=new Date()*1000;// spoof microsecond
}if(this.config.otp!==undefined){params.otp=this.config.otp;}var signature=getMessageSignature(path,params,this.config.secret,params.nonce);var headers={'API-Key':this.config.key,'API-Sign':signature};var response=rawRequest(url,headers,params,this.config.timeout);if(typeof callback==='function'){response.then(function(result){return callback(null,result);}).catch(function(error){return callback(error,null);});}return response;}}]);return KrakenClient;}();
